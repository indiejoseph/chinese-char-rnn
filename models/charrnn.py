...
class CharRNN(Model):
  def __init__(self, vocab_size=1000, batch_size=100,
    ...
    for qrnn_l in range(self.layer_depth):
      qrnn_ = QRNNCell(self.rnn_size, pool_type="fo",
